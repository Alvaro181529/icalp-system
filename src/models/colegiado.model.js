...
class ColegiadoModel {
  ...
  async updateUser(id, query, user) {
    ...
    const updateData = {
      FechaMatriculacionAlColegio: fechaMatriculacionAlColegio
        ...
        : null,
      Matricula: matricula,
      MatriculaConalab: matriculaConalab ? matriculaConalab : null,
      ...
      NumeroCI: numeroCI ? numeroCI : null,
      NumeroRuc: numeroRuc ? numeroRuc : null,
      EstadoCivil: estadoCivil,
      Genero: estadoGenero,
      Universidad: universidad,
      FechaTesis: fechaTesis ? fechaTesis : null,
      UniversidadLicenciatura: universidadLicenciatura,
      FechaLicenciatura: fechaLicenciatura ? fechaLicenciatura : null,
      ...
      MontoDeposito: montoDeposito ? montoDeposito : 0.0,
  ...
  async postUser(query, user) {
    ...
    FechaNacimiento, NumeroCI, NumeroRuc, EstadoCivil, Genero, Universidad, FechaTesis, UniversidadLicenciatura, FechaLicenciatura, 
