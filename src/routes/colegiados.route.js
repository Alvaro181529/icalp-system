...
router.get("/colegiados", checkRole(["Administrador", "Cobrador","Colegiados","Tribunal","Postgrado"]), colegiado.getColegiados);
...
router.get("/colegiado/:id", checkRole(["Administrador", "Cobrador","Colegiados","Tribunal","Postgrado"]), colegiado.getColegiado);

// Rutas para la API de colegiado
router.get("/collegiate", checkRole(["Administrador", "Cobrador","Colegiados","Tribunal","Postgrado"]), colegiado.getCollegiatesAdmin);
...
router.get("/collegiate/:id", checkRole(["Administrador", "Cobrador", "Colegiados","Tribunal","Postgrado"]), colegiado.getCollegiate);
router.post("/collegiate", checkRole(["Administrador", "Cobrador","Tribunal","Postgrado"]), colegiado.postCollegiate);
